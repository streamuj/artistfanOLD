...
abstract class BasePagesPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Pagename', 'Sortid', 'Story', 'Active', 'Pdate', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'pagename', 'sortid', 'story', 'active', 'pdate', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::PAGENAME, self::SORTID, self::STORY, self::ACTIVE, self::PDATE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'PAGENAME', 'SORTID', 'STORY', 'ACTIVE', 'PDATE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'pagename', 'sortid', 'story', 'active', 'pdate', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Pagename' => 2, 'Sortid' => 3, 'Story' => 4, 'Active' => 5, 'Pdate' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'pagename' => 2, 'sortid' => 3, 'story' => 4, 'active' => 5, 'pdate' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::PAGENAME => 2, self::SORTID => 3, self::STORY => 4, self::ACTIVE => 5, self::PDATE => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'PAGENAME' => 2, 'SORTID' => 3, 'STORY' => 4, 'ACTIVE' => 5, 'PDATE' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'pagename' => 2, 'sortid' => 3, 'story' => 4, 'active' => 5, 'pdate' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(PagesPeer::PAGENAME);
			$criteria->addSelectColumn(PagesPeer::SORTID);
			$criteria->addSelectColumn(PagesPeer::STORY);
			$criteria->addSelectColumn(PagesPeer::ACTIVE);
			$criteria->addSelectColumn(PagesPeer::PDATE);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.TITLE');
			$criteria->addSelectColumn($alias . '.PAGENAME');
	 ...
	 *
	 * @param      Pages $value A Pages object.
