...
/**
 * Base class that represents a row from the 'photo_album' table.
 *
 * 
 *
...
abstract class BasePhotoAlbum extends BaseObject  implements Persistent
{
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = PhotoAlbumPeer::USER_ID;
		}
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = PhotoAlbumPeer::TITLE;
		}
	...
	public function setPdate($v)
	{
		...
		if ($this->pdate !== $v) {
			$this->pdate = $v;
			$this->modifiedColumns[] = PhotoAlbumPeer::PDATE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = PhotoAlbumPeer::NUM_HYDRATE_COLUMNS.
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = PhotoAlbumQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(PhotoAlbumPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(PhotoAlbumPeer::USER_ID)) {
			$modifiedColumns[':p' . $index++]  = '`USER_ID`';
		}
		if ($this->isColumnModified(PhotoAlbumPeer::TITLE)) {
			$modifiedColumns[':p' . $index++]  = '`TITLE`';
		}
		if ($this->isColumnModified(PhotoAlbumPeer::PDATE)) {
			$modifiedColumns[':p' . $index++]  = '`PDATE`';
		}

		$sql = sprintf(
			'INSERT INTO `photo_album` (%s) VALUES (%s)',
	...
	{
		if (isset($alreadyDumpedObjects['PhotoAlbum'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['PhotoAlbum'][$this->getPrimaryKey()] = true;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PhotoAlbumPeer::USER_ID)) $criteria->add(PhotoAlbumPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(PhotoAlbumPeer::TITLE)) $criteria->add(PhotoAlbumPeer::TITLE, $this->title);
		if ($this->isColumnModified(PhotoAlbumPeer::PDATE)) $criteria->add(PhotoAlbumPeer::PDATE, $this->pdate);
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aUser->addPhotoAlbums($this);
			 */
		}
		return $this->aUser;
	}
	 ...
	 * If this PhotoAlbum is new, it will return
	 ...
	 * Otherwise if this PhotoAlbum is new, it will return
	 * an empty collection; or if this PhotoAlbum has previously
	 * been saved, it will retrieve related Photos from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in PhotoAlbum.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array Photo[] List of Photo objects
	 */
	public function getPhotosJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PhotoQuery::create(null, $criteria);
	...
	{
		return (string) $this->exportTo(PhotoAlbumPeer::DEFAULT_STRING_FORMAT);
	}
