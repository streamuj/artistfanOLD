...
abstract class BaseStatePeer {
	...
	const CLASS_DEFAULT = 'artistfan.State';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('StateCode', 'StateName', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('stateCode', 'stateName', ),
		BasePeer::TYPE_COLNAME => array (self::STATE_CODE, self::STATE_NAME, ),
		BasePeer::TYPE_RAW_COLNAME => array ('STATE_CODE', 'STATE_NAME', ),
		BasePeer::TYPE_FIELDNAME => array ('state_code', 'state_name', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('StateCode' => 0, 'StateName' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('stateCode' => 0, 'stateName' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::STATE_CODE => 0, self::STATE_NAME => 1, ),
		BasePeer::TYPE_RAW_COLNAME => array ('STATE_CODE' => 0, 'STATE_NAME' => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('state_code' => 0, 'state_name' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(StatePeer::STATE_CODE);
	...
	/**
	 * Performs an UPDATE on the database, given a State or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(StatePeer::STATE_CODE);
			$value = $criteria->remove(StatePeer::STATE_CODE);
			if ($value) {
				$selectCriteria->add(StatePeer::STATE_CODE, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(StatePeer::STATE_CODE, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(StatePeer::STATE_CODE, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(StatePeer::DATABASE_NAME);
			$criteria->add(StatePeer::STATE_CODE, $pks, Criteria::IN);
