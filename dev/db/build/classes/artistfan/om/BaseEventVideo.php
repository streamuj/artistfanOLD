...
abstract class BaseEventVideo extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BaseEventVideo object.
	 * @see        applyDefaults()
	 */
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = EventVideoPeer::USER_ID;
		}
	...
	public function setVideo($v)
	{
		...
		if ($this->video !== $v) {
			$this->video = $v;
			$this->modifiedColumns[] = EventVideoPeer::VIDEO;
		}
	...
	public function setOrder($v)
	{
		...
		if ($this->order !== $v) {
			$this->order = $v;
			$this->modifiedColumns[] = EventVideoPeer::ORDER;
		}
	...
	public function setPdate($v)
	{
		...
		if ($this->pdate !== $v) {
			$this->pdate = $v;
			$this->modifiedColumns[] = EventVideoPeer::PDATE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->video = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			return $startcol + 6; // 6 = EventVideoPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(EventVideoPeer::USER_ID)) {
			$modifiedColumns[':p' . $index++]  = '`USER_ID`';
		}
		if ($this->isColumnModified(EventVideoPeer::VIDEO)) {
			$modifiedColumns[':p' . $index++]  = '`VIDEO`';
		}
		if ($this->isColumnModified(EventVideoPeer::ORDER)) {
			$modifiedColumns[':p' . $index++]  = '`ORDER`';
		}
		if ($this->isColumnModified(EventVideoPeer::PDATE)) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setVideo($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EventVideoPeer::USER_ID)) $criteria->add(EventVideoPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(EventVideoPeer::VIDEO)) $criteria->add(EventVideoPeer::VIDEO, $this->video);
		if ($this->isColumnModified(EventVideoPeer::ORDER)) $criteria->add(EventVideoPeer::ORDER, $this->order);
		if ($this->isColumnModified(EventVideoPeer::PDATE)) $criteria->add(EventVideoPeer::PDATE, $this->pdate);
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aUser->addEventVideos($this);
			 */
		}
		return $this->aUser;
	}
