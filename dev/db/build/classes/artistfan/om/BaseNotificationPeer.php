...
abstract class BaseNotificationPeer {
	...
	const CLASS_DEFAULT = 'artistfan.Notification';
	...
	/** the column name for the NA_ID field */
	const NA_ID = 'notification.NA_ID';

	/** the column name for the NA_WALL_ID field */
	const NA_WALL_ID = 'notification.NA_WALL_ID';

	/** the column name for the NA_COMMENT_ID field */
	const NA_COMMENT_ID = 'notification.NA_COMMENT_ID';

	/** the column name for the NA_MESSAGE field */
	const NA_MESSAGE = 'notification.NA_MESSAGE';

	/** the column name for the NA_USER_ID field */
	const NA_USER_ID = 'notification.NA_USER_ID';

	/** the column name for the NA_STATUS field */
	const NA_STATUS = 'notification.NA_STATUS';

	/** the column name for the NA_DATE field */
	const NA_DATE = 'notification.NA_DATE';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('NaId', 'NaWallId', 'NaCommentId', 'NaMessage', 'NaUserId', 'NaStatus', 'NaDate', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('naId', 'naWallId', 'naCommentId', 'naMessage', 'naUserId', 'naStatus', 'naDate', ),
		BasePeer::TYPE_COLNAME => array (self::NA_ID, self::NA_WALL_ID, self::NA_COMMENT_ID, self::NA_MESSAGE, self::NA_USER_ID, self::NA_STATUS, self::NA_DATE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('NA_ID', 'NA_WALL_ID', 'NA_COMMENT_ID', 'NA_MESSAGE', 'NA_USER_ID', 'NA_STATUS', 'NA_DATE', ),
		BasePeer::TYPE_FIELDNAME => array ('na_id', 'na_wall_id', 'na_comment_id', 'na_message', 'na_user_id', 'na_status', 'na_date', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('NaId' => 0, 'NaWallId' => 1, 'NaCommentId' => 2, 'NaMessage' => 3, 'NaUserId' => 4, 'NaStatus' => 5, 'NaDate' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('naId' => 0, 'naWallId' => 1, 'naCommentId' => 2, 'naMessage' => 3, 'naUserId' => 4, 'naStatus' => 5, 'naDate' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::NA_ID => 0, self::NA_WALL_ID => 1, self::NA_COMMENT_ID => 2, self::NA_MESSAGE => 3, self::NA_USER_ID => 4, self::NA_STATUS => 5, self::NA_DATE => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('NA_ID' => 0, 'NA_WALL_ID' => 1, 'NA_COMMENT_ID' => 2, 'NA_MESSAGE' => 3, 'NA_USER_ID' => 4, 'NA_STATUS' => 5, 'NA_DATE' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('na_id' => 0, 'na_wall_id' => 1, 'na_comment_id' => 2, 'na_message' => 3, 'na_user_id' => 4, 'na_status' => 5, 'na_date' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(NotificationPeer::NA_ID);
			$criteria->addSelectColumn(NotificationPeer::NA_WALL_ID);
			$criteria->addSelectColumn(NotificationPeer::NA_COMMENT_ID);
			$criteria->addSelectColumn(NotificationPeer::NA_MESSAGE);
			$criteria->addSelectColumn(NotificationPeer::NA_USER_ID);
			$criteria->addSelectColumn(NotificationPeer::NA_STATUS);
			$criteria->addSelectColumn(NotificationPeer::NA_DATE);
		} else {
			$criteria->addSelectColumn($alias . '.NA_ID');
			$criteria->addSelectColumn($alias . '.NA_WALL_ID');
			$criteria->addSelectColumn($alias . '.NA_COMMENT_ID');
			$criteria->addSelectColumn($alias . '.NA_MESSAGE');
			$criteria->addSelectColumn($alias . '.NA_USER_ID');
			$criteria->addSelectColumn($alias . '.NA_STATUS');
			$criteria->addSelectColumn($alias . '.NA_DATE');
		}
	}
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(NotificationPeer::NA_ID) && $criteria->keyContainsValue(NotificationPeer::NA_ID) ) {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(NotificationPeer::NA_ID);
			$value = $criteria->remove(NotificationPeer::NA_ID);
			if ($value) {
				$selectCriteria->add(NotificationPeer::NA_ID, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(NotificationPeer::NA_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(NotificationPeer::NA_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(NotificationPeer::DATABASE_NAME);
			$criteria->add(NotificationPeer::NA_ID, $pks, Criteria::IN);
