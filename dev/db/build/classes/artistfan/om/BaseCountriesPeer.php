...
abstract class BaseCountriesPeer {
	...
	const PCODE = 'countries.PCODE';

	/** the column name for the SORTID field */
	const SORTID = 'countries.SORTID';
	...
	/**
	 * An identiy map to hold any loaded instances of Countries objects.
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Iso2', 'Name', 'Pcode', 'Sortid', 'Iso3', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('iso2', 'name', 'pcode', 'sortid', 'iso3', ),
		BasePeer::TYPE_COLNAME => array (self::ISO2, self::NAME, self::PCODE, self::SORTID, self::ISO3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ISO2', 'NAME', 'PCODE', 'SORTID', 'ISO3', ),
		BasePeer::TYPE_FIELDNAME => array ('iso2', 'name', 'pcode', 'sortid', 'iso3', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Iso2' => 0, 'Name' => 1, 'Pcode' => 2, 'Sortid' => 3, 'Iso3' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('iso2' => 0, 'name' => 1, 'pcode' => 2, 'sortid' => 3, 'iso3' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ISO2 => 0, self::NAME => 1, self::PCODE => 2, self::SORTID => 3, self::ISO3 => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ISO2' => 0, 'NAME' => 1, 'PCODE' => 2, 'SORTID' => 3, 'ISO3' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('iso2' => 0, 'name' => 1, 'pcode' => 2, 'sortid' => 3, 'iso3' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CountriesPeer::PCODE);
			$criteria->addSelectColumn(CountriesPeer::SORTID);
	 ...
	 *
	 * @param      Countries $value A Countries object.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(CountriesPeer::ISO2);
			$value = $criteria->remove(CountriesPeer::ISO2);
			if ($value) {
				$selectCriteria->add(CountriesPeer::ISO2, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(CountriesPeer::ISO2, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(CountriesPeer::ISO2, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(CountriesPeer::DATABASE_NAME);
			$criteria->add(CountriesPeer::ISO2, $pks, Criteria::IN);
