...
class StateTableMap extends TableMap
{
	 ...
	 */
	const CLASS_NAME = 'artistfan.map.StateTableMap';
	...
	public function initialize()
	{
		...
		// columns
		$this->addPrimaryKey('STATE_CODE', 'StateCode', 'CHAR', true, 2, null);
		$this->addColumn('STATE_NAME', 'StateName', 'VARCHAR', false, 150, '');
		// validators
	} // initialize()
