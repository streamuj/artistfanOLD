...
/**
 * This class defines the structure of the 'music_buy' table.
 *
 *
 *
 ...
 */
class MusicBuyTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'artistfan.map.MusicBuyTableMap';
	...
	{
		// attributes
		$this->setName('music_buy');
		$this->setPhpName('MusicBuy');
		$this->setClassname('MusicBuy');
