...
class WallTableMap extends TableMap
{
	...
	public function initialize()
	{
		...
		$this->addColumn('VIDEO', 'Video', 'LONGVARCHAR', false, null, null);
		$this->addColumn('PDATE', 'Pdate', 'INTEGER', false, 11, 0);
		$this->addColumn('CDATE', 'Cdate', 'INTEGER', false, 11, 0);
		$this->addColumn('TIMELINE', 'Timeline', 'INTEGER', false, 11, 0);
		$this->addColumn('LINK', 'Link', 'VARCHAR', false, 255, '');
		$this->addColumn('ACTION', 'Action', 'VARCHAR', false, 20, '');
		// validators
	} // initialize()
