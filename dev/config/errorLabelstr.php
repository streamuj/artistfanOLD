...
define('YOU_ARE_CONNECTED_SUCCESSFULLY','You are connected successfully');
...
define('PLEASE_SPECIFY_PHONE_NUMBER_AS_INTEGER', 'Please specify correct phone number');
define('PLEASE_ENTER_A_VALID_CVV_CODE', 'Please enter a valid CVV code');
define('PLEASE_ENTER_EXPIRY_MONTH_AND_YEAR', 'Please enter expiry month and year');
define('PLEASE_ENTER_VALIDATE_MONTH_AND_YEAR', 'Please enter validate month and year');
define('PLEASE_ENTER_VALIDATE_CARD_NUMBER', 'Please enter validate card number');
define('PLEASE_ENTER_VALIDATE_CARD_NUMBER_AND_CARD_TYPE', 'Please enter validate card number & card type');
...
define('YOUR_SESSION_EXPIRED_LOGIN_AGAIN', 'Your session time out login again');
