...
(function() {
        ...
        fdSliderController = {
                ...
                onload: function(e) {
                        for(var slider in fdSliderController.sliders) { fdSliderController.sliders[slider].resetHandlePosition(); }
                },
                ...
                deconstruct: function( e ) {
                        for(var slider in fdSliderController.sliders) { fdSliderController.sliders[slider].destroy(); };
