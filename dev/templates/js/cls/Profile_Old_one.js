...
Profile.prototype =
{
	...
	*/
		...
		{
			alert("Price == "+values+"Current Price=="+currentPrice);	
		},
	   ...
	   PayMoreMusic: function(id, title, price, image, artist_url, artist_band, atrist_genres, in_player)
    {
        ...
        if(price > 0)
        {
           /* $( "#buy_music_dialog" ).find('.price strong').html( price );*/
          /*  $( "#buy_music_dialog" ).find('.price').show(); */
            $( "#buy_music_dialog" ).find('.price').html('<input type="text" style="width:85px;height:25px;" onblur="return  oProfile.verifyPayMore(this.value,10);" >'); 	  			
