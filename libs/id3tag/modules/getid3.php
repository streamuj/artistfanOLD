...
{
	// public: Settings
	var $encoding        = 'Windows-1251';   // CASE SENSITIVE! - i.e. (must be supported by iconv())
	                                       // Examples:  ISO-8859-1  UTF-8  UTF-16  UTF-16BE

	var $encoding_id3v1  = 'Windows-1251';   // Should always be 'ISO-8859-1', but some tags may be written in other encodings such as 'EUC-CN'
