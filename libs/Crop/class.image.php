...
class simpleImage {
   ...
   function save($filename, $image_type=IMAGETYPE_JPEG, $compression=100, $permissions=0644) {
      if( $this->image_type == IMAGETYPE_JPEG ) {
   ...
   function resizeImage($destWidth, $destHeight, $type = true, $backgroundColor = array(), $centre=false)
   {
	...
	public function resizeThumbnailImage($thumb_image_name, $width, $height, $start_width, $start_height, $scale){
	...
	{
		$stamp	=	BPATH.'dev/skin/images/stamp.png';
